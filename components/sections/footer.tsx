...
export function Footer() {
  ...
  return (
    <footer>
      ...
      <div className="wrap cofepris-avisos">
        <span><strong>Aviso de publicidad COFEPRIS:</strong> 2609142002A00578</span>
        <span><strong>Aviso de funcionamiento COFEPRIS:</strong> 2309145036X00795</span>
      </div>
